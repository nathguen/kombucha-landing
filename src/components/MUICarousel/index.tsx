...
function MUICarousel() {
  ...
  let carouselHeight = pageHeight / carouselRatio;
  let carouselWidth = pageWidth * carouselRatio;

  if (isMobile) {
    carouselHeight = pageHeight * 0.5;
    carouselWidth = carouselHeight * carouselRatio;
  }
